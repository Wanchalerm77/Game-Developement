...
/**
 * The Class Protocol implements the protocol and provides functions to help
 * implementing the protocol. This protocol is for Group 7, Mod02 BIT/INF
 * 2016/2017, UTWENTE
 */
public class Protocol {
	 ...
	 * 
	 * @param number
	 *            String with error code defined in Protocol
